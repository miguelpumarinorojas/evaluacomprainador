...
<body>
    ...
    if (isset($_POST['btnRegistrar']) && !empty($_POST['CodigoSupermercado']) && !empty($_POST['DescripcionSupermercado'])) {
        ...
        $validarCodigo = $conn->prepare("SELECT * FROM supermercados WHERE codigo = ?");
        $validarCodigo->bind_param("s", $codigoSupermercado);
    ...
    <nav aria-label="breadcrumb" class="bg-light py-2 px-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span class="material-icons align-bottom">storefront</span>Supermercados</li>
        </ol>
    </nav>
    <div class="container-fluid">
        <div class="row pt-2">
                ...
                <form action="" method="POST" class="needs-validation" autocomplete="off" enctype="multipart/form-data" novalidate>
                    <div class="card">
                        <div class="card-header bg-secondary text-white">
                            <span class="material-icons align-bottom">add</span> Registro de Supermercados
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="CodigoSupermercado" class="form-label"><span class="material-icons align-bottom">label</span> Codigo del Supermercado</label>
                                        <input type="text" class="form-control" id="CodigoSupermercado" name="CodigoSupermercado" placeholder="Codigo del Supermercado" maxlength="20" required>
                                ...
                                <div class="col-md-9">
                                    <div class="mb-3">
                                        <label for="DescripcionSupermercado" class="form-label"><span class="material-icons align-bottom">text_fields</span> Descripción del Supermercado</label>
                                        <input type="text" class="form-control" id="DescripcionSupermercado" name="DescripcionSupermercado" placeholder="Descripción del Supermercado" maxlength="200" required>
                                        <div class="invalid-feedback">
                                            Ingrese la descripción del supermercado.
                                        </div>
                                    </div>
        ...
        <div class="row pt-2">
            <div class="col">
                <div class="card">
                    <div class="card-header bg-secondary text-white">
                        <span class="material-icons align-bottom">list</span> Lista de Supermercados
                    </div>
                    <div class="card-body">
                        <?php include("listaSupermercado.php"); ?>
                    </div>
                </div>
            </div>
