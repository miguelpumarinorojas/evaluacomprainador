    ...
    <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <a href="generarlistascompras" class="text-decoration-none text-dark">
                            <h5 class="card-title"><span class="material-icons align-bottom">list_alt</span> Generar Listas de Cotizaciones</h5>
                        </a>
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <a href="maestros" class="text-decoration-none text-dark">
                            <h5 class="card-title"><span class="material-icons align-bottom">list_alt</span> Maestros</h5>
                        </a>
        ...
        <div class="row">
            <div class="col">
                <div class="card mt-2">
                    <div class="card-body">
                        <a href="compras" class="text-decoration-none text-dark">
                            <h5 class="card-title"><span class="material-icons align-bottom">shopping_cart</span> Crear lista de compras</h5>
                        </a>
